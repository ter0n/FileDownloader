...
public class MultiThreadedFileLoaderTest {
    ...
    public void tryCreateDirectory() {
        ...
        MultiThreadedFileLoader multiThreadedFileLoader = new MultiThreadedFileLoader(speedLimit, threadCount, directoryName);
    ...
    public void loadedFilesCheck(){
        ...
        String testFileDir = "files_for_test";

        int speedLimit = 1500;
        int threadCount = 1;
        String directoryName = "download";
    ...
    public void getSpeedLimit() {
        ...
        int bufSize = 1024;
        int expected = multiThreadedFileLoader.getSpeedLimit();
